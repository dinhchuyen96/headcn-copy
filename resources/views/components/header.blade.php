        ...
        <ul class="nav navbar-toolbar">
            <li class="dropdown dropdown-user">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{{ route('profile') }}"><i class="fa fa-user"></i>Trang cá nhân</a>
                    <a class="dropdown-item" href="{{ route('support') }}"><i class="fa fa-support"></i>Hỗ trợ</a>
                    <!-- <li class="dropdown-divider"></li> -->
                    <a class="dropdown-item" href="{{ route('user.doLogout') }}"><i class="fa fa-power-off"></i>Đăng xuất</a>
                </ul>
            </li>
        </ul>
