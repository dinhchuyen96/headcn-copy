<div>
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Danh sách kho</div>
            </div>
            <div class="ibox-body">
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="category-table_filter" class="dataTables_filter">
                                <a href="{{ route('kho.themmoi.index') }}" class="btn btn-outline-primary">
                                <i class="fa fa-plus-circle"></i>
                                    THÊM MỚI</a>
                                <button data-target="#modal-form-import" data-toggle="modal" type="button"
                                class="btn btn-info add-new" >
                                <i class="fa fa-upload" aria-hidden="true"></i>IMPORT</button>
                                    ...
                                    @forelse($data as $key => $value)
                                        <tr data-parent="" data-index="1" role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('kho.capnhat.index', $value->id) }}"
