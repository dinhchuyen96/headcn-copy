<div>
    <div class="page-heading">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Danh sách trả lại hàng bán</li>
        </ol>
    </div>
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Danh sách trả lại hàng bán</div>
            </div>
            <div class="ibox-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div id="category-table_filter" class="dataTables_filter">
                                <a href="{{ route('hangtralai.ban.create') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i>
                                    Thêm mới</a>
                            </div>
                        </div>
                                    ...
                                    @forelse ($data as $item)
                                        <tr data-parent="" data-index="1" role="row" class="odd">
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('hangtralai.ban.edit', $item->id) }}"
