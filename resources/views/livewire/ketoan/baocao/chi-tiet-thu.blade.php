<div>
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Danh sách phải thu</div>
            </div>
            <div wire:loading class="loader"></div>
            <div class="ibox-body">
                <form>
                    <div class="form-group row">
                        <label for="CustomerName" class="col-1 col-form-label ">Số điện thoại</label>
                        <div class="col-3">
                            <input id="CustomerName" name="CustomerName" type="number" class="form-control form-red"
                                placeholder='Nhập Số điện thoại'
                                wire:model.debounce.1000ms='customerPhone'>
                        </div>
                        <label for="CustomerName" class="col-1 col-form-label ">Số khung</label>
                        <div class="col-3">
                            <input type="text" class="form-control" placeholder='Số khung'
                                wire:model.debounce.1000ms='chassicNo'>
                        </div>
                        <label for="CustomerName" class="col-1 col-form-label ">Biển số</label>
                        <div class="col-3">
                            <input type="text" class="form-control" placeholder='Biển số'
                                wire:model.debounce.1000ms='motorNumbers'>
                        </div>
                    </div>
                    <div class="form-group row">
                        
                        <label for="CustomerName" class="col-1 col-form-label ">Số máy</label>
                        <div class="col-3">
                            <input type="text" class="form-control" placeholder='Số máy'
                                wire:model.debounce.1000ms='engineNo'>
                        </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="{{ $key_name == 'code' ? ($sortingName == 'desc' ? 'sorting_desc' : 'sorting_asc') : 'sorting' }}"
                                            ...
                                            style="width: 164.5px;" wire:click='sorting("code")'>Mã KH</th>
                                        ...
                                        <th class="{{ $key_name2 == 'total_money2' ? ($sortingName2 == 'desc' ? 'sorting_desc' : 'sorting_asc') : 'sorting' }}"
                                            ...
                                            toán</th>
                                        <th tabindex="0" aria-controls="category-table" rowspan="1" colspan="1"
                                            style="width: 164.5px;">Dư nợ phải thu</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse ($data as $key => $value)
                                        ...
                                        @elseif($value->type_table == 0)
                                            <tr class="text-danger">
                                                <td colspan="8"><strong>Dư nợ cuối phải thu</strong></td>
