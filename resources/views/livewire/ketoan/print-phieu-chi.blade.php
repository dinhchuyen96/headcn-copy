<div class="container">
    ...
    <div style="display: flex">
        ...
        <div style="flex: 50%; text-align: center">
            <p>
                <b
                    >Ngày {{ $data["day"] }} tháng {{ $data["month"] }} năm
                    {{ $data["year"] }}
                </b>
            </p>
        </div>
    ...
    <p style="text-align: left">Họ tên người nhận tiền: {{ $data["name"] }}</p>
    <p style="text-align: left">Địa chỉ: {{ $data["address"] }}</p>
    <p style="text-align: left">Lý do chi: {{ $data["reason"] }}</p>
    <p style="text-align: left">
        Số tiền: <b>{{ number_format($data["totalPrice"]) }} VND</b>
    </p>
    <p style="text-align: left">
        Viết bằng chữ: <b>{{ docsothanhchu($data["totalPrice"]) }}</b>
    </p>
    <p style="text-align: left">
        Kèm theo:
        ...............................................................................................................................
    ...
    <p style="margin-top: 50px">
        Đã nhận đủ số tiền (Viết bằng chữ) :
