...
<div>
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Xuất ngoại lệ</div>
            </div>
            <div class="ibox-body">
                <form>
                    <div class="form-group row">
                        <label for="warehouses" class="col-1 col-form-label ">Kho xuất<span class="text-danger">*</span></label>
                        <div class="col-3">
                            <select {{ $readOnly ? 'disabled' : '' }} wire:model="warehouses" id="warehouses" class="custom-select select2-box">
                                <option hidden value="0">Chọn Kho</option>
                        ...
                        <div class="col-3">
                            <select {{ $readOnly ? 'disabled' : '' }} wire:model="position_in_warehouse" id="position_in_warehouse"
                                class="custom-select select2-box">
                                <option hidden value="0">Chọn vị trí</option>
